...
import styles from "./CadastroConsultaAgendamento.module.css";
const CadastroConsultaAgendamento = () => {
  ...
  return (
    <div className={styles.cadastroconsultaagendamento}>
      <div className={styles.rectangleParent}>
        ...
        >
          <div className={styles.botoPrximo1} />
          <div className={styles.prximo}>Próximo</div>
        </button>
      </div>
      <div className={styles.cadastroconsultaagendamentoChild} />
...
export default CadastroConsultaAgendamento;
